...
@section('main')
  ...
  <div class="row">
    <div class="col">
      <form action="/recipes" method="POST" style="width:750px;margin:auto;">
        @csrf
        ...
        <div class="form-group mb-3">
          ...
          <div>
            ...
            <textarea id="directions" name="directions" class="form-control" placeholder="i.e. First wash your hands...">{{old('directions')}}
            </textarea>
